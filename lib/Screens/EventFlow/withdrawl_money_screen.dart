...
class WithDrawlMoneyScreen extends StatefulWidget {
  const WithDrawlMoneyScreen({Key? key}) : super(key: key);

  @override
  State<WithDrawlMoneyScreen> createState() => _WithDrawlMoneyScreenState();
}

class _WithDrawlMoneyScreenState extends State<WithDrawlMoneyScreen> {
  @override
