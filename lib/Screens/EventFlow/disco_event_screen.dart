  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:  AppBar(
        ...
        title: Text("Disco Event",style: TextStyle(color: Colors.white),),
        centerTitle: true,
        toolbarHeight: 70,
      ),
                          ...
                          child: Padding(
                            ...
                            child: Swiper(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return Image.asset('assets/images/Rectangle36.png',fit: BoxFit.contain,);
                              },
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const AddText(text: "18225 Biscayne Blvd, Aventura, Jaipur"),
                    ],
                  ),
                ),
              ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AddText(text: 'Read more',decoration: TextDecoration.underline,fontWeight: FontWeight.w400)
                    ],
                  ),
                ),
              ),
                        ...
                        children: [
                          Container(
                            ...
                            child: Swiper(
                              ...
                              itemCount: 3,
                              itemBuilder: (BuildContext context, int index) {
                                return Image.asset('assets/images/Rectangle50.png',fit: BoxFit.contain,);
                              },
                              // pagination: const SwiperPagination(),
                              control: const SwiperControl(
                                  size: 30,color: Colors.white,padding: EdgeInsets.all(15)),
