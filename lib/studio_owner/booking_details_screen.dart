...
class BookingDetailsScreen2 extends StatefulWidget {
  const BookingDetailsScreen2({Key? key}) : super(key: key);

  @override
  State<BookingDetailsScreen2> createState() => _BookingDetailsScreen2State();
}

class _BookingDetailsScreen2State extends State<BookingDetailsScreen2> {
  @override
            ...
            children: [
              ...
              ElevatedButton(onPressed: ()
              {
                Get.toNamed(MyRouter.leaveReviewScreen);
                  ...
                  child: const Center(child: AddText(text: 'Send Message',color:Colors.white,fontWeight: FontWeight.w600))
              ),
